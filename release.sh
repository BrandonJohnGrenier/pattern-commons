...
mvn release:clean release:prepare --settings ${MVN_SETTINGS} -B -Dusername=$GIT_REPO_USERNAME -Dpassword=$GIT_REPO_PASSWORD -DautoVersionSubmodules=true -DskipTests=true -Darguments="--settings ${MVN_SETTINGS}"
